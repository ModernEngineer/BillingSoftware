        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasePrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentPrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExpensePrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SaleReturnPrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PurchaseReturnPrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductionPrefix = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SaleCounter = table.Column<int>(type: "int", nullable: false),
                    PurchaseCounter = table.Column<int>(type: "int", nullable: false),
                    PaymentCounter = table.Column<int>(type: "int", nullable: false),
                    ExpenseCounter = table.Column<int>(type: "int", nullable: false),
                    SaleReturnCounter = table.Column<int>(type: "int", nullable: false),
                    PurchaseReturnCounter = table.Column<int>(type: "int", nullable: false),
                    ProductionCounter = table.Column<int>(type: "int", nullable: false),
                    ...
                    ShowHsn = table.Column<bool>(type: "bit", nullable: false),
                    ShowSignature = table.Column<bool>(type: "bit", nullable: false),
                    ShowTerms = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GstRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    MaximumStock = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BOMItems_Products_FinishedProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadActivities_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleReturns_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductionConsumptions_Products_ComponentProductId",
                        column: x => x.ComponentProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BOMItems_FinishedProductId_ComponentProductId",
                table: "BOMItems",
                columns: new[] { "FinishedProductId", "ComponentProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadActivities_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionConsumptions_ComponentProductId",
                table: "ProductionConsumptions",
                column: "ComponentProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionConsumptions_ProductionOrderId",
                table: "ProductionConsumptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleReturns_CreatedById",
                table: "SaleReturns",
                column: "CreatedById");
